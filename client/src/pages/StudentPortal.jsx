                ...
                <table>
                    ...
                    <tbody>
                        {getDisplaySubmissions().length === 0 ? (
                            <tr><td colSpan="6" style={{ textAlign: 'center', padding: '3rem' }}>No submissions yet</td></tr>
                        ) : (
                            getDisplaySubmissions().map(sub => (
                                <tr key={sub.id}>
                                    <td><div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Clock size={14} style={{ color: 'var(--text-muted)' }} />{new Date(sub.submittedAt).toLocaleString()}</div></td>
                                    <td>
                                        <span style={{
                                            fontSize: '0.75rem',
                                            padding: '2px 8px',
